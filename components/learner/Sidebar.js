...
const NAV_ITEMS = [
    { label: "Mon Espace", href: "/apprenant", icon: LayoutDashboard },
    { label: "Mes Formations", href: "/apprenant/mes-formations", icon: BookOpen },
    { label: "Mon Planning", href: "/apprenant/mon-planning", icon: Calendar },
